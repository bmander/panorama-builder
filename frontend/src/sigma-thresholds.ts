...
export const SIGMA_POS_WARN_M = 25;
export const SIGMA_POS_REFUSE_M = 50;    // = mergeSigmaPosRefuseM
export const SIGMA_ALT_WARN_M = 5;
export const SIGMA_ALT_REFUSE_M = 10;    // = mergeSigmaAltRefuseM
